    ...
    public partial class CreacionModeloNegocio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conyugues", x => x.ConyugeId);
                    table.ForeignKey(
                        name: "FK_Conyugues_Empleados_EmpleadoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hjos", x => x.HijoId);
                    table.ForeignKey(
                        name: "FK_Hjos_Empleados_AncestroEmpleadoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hjos_AncestroEmpleadoId",
                table: "Hjos",
